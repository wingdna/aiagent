...
export const CONFIG = {
  ...
  SUPABASE_URL: (import.meta as any).env?.VITE_SUPABASE_URL || 'https://kumviyxbodfktoamgazw.supabase.co',
  SUPABASE_KEY: (import.meta as any).env?.VITE_SUPABASE_ANON_KEY || 'sb_publishable_gp2I7s0aQDXmEYpP_s1eLQ_2gNKv-OI',
