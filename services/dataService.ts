...
export const QUERY_FIELDS = {
  AGENTS_FULL: 'id, slug, name, description, entity_type, nri_score, hot_score, video_url, cover_url, display_mode, specs, pricing_model, pricing_model_json, metrics, capability_tags, media_gallery, vendor_id, vendor_slug, slogan, technical_specs, social_proof, external_stats, framework_stack, developer_socials',
  AGENTS_DETAIL: 'id, slug, name, description, full_description, category, nri_score, hot_score, entity_type, video_url, cover_url, display_mode, specs, pricing_model, pricing_model_json, metrics, capability_tags, tags, media_gallery, vendor_id, vendor_slug, slogan, technical_specs, social_proof, external_stats, framework_stack, developer_socials, connectivity, voice_config, market_analysis',
  AGENTS_MINIMAL: 'id, slug, name, description, entity_type, nri_score, hot_score, video_url, cover_url, display_mode, specs, pricing_model, pricing_model_json, metrics, capability_tags, media_gallery, vendor_id, vendor_slug, slogan',
  INTEL: 'id, agent_slug, intel_type, title, summary, source_url, published_at, created_at, agent_id_link, image_url',
  POSTS: 'id, agent_id_link, content, created_at, post_type, status',
...
class DataService {
  ...
  public async findSimilarAgents(agent: Agent, count?: number) {
  ...
  public async getAgentIntel(agentId: string) {
    const { contentService } = await import('./contentService');
    return contentService.getAgentIntel(agentId);
  }
  ...
  public async getExpertReview(agentId: string) {
    const { contentService } = await import('./contentService');
    return contentService.getExpertReview(agentId);
  }
