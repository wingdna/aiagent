...
export const AeroVideoPlaceholder: React.FC<AeroVideoPlaceholderProps> = ({ videoId, title = 'Video', posterUrl }) => {
  ...
  const thumbnailUrl = posterUrl || `https://img.youtube.com/vi/${videoId}/maxresdefault.jpg`;
          ...
          >
            ...
            >
              ...
              <iframe
                ...
                src={`https://www.youtube.com/embed/${videoId}?autoplay=1&modestbranding=1&rel=0${!isMobile ? '&mute=1' : ''}`}
                title={title}
                frameBorder="0"
                referrerPolicy="no-referrer"
