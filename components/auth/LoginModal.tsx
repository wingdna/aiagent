    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/95 backdrop-blur-md">
            <motion.div 
                ...
                className="w-full max-w-md bg-black border border-matrix-green/30 shadow-[0_0_50px_rgba(0,255,65,0.15)] relative overflow-hidden clip-angle"
            >
                {/* Header */}
                <div className="bg-matrix-green/10 p-4 border-b border-matrix-green/30 flex justify-between items-center">
                    <div className="flex items-center gap-2 text-matrix-green font-display font-bold tracking-widest text-sm">
                        <Terminal size={16} />
                        YOUAGENT_AUTHENTICATION
                    </div>
                    <button onClick={onClose} className="text-matrix-green/50 hover:text-white transition-colors">
                        <X size={18} />
                    </button>
                </div>
                ...
                <div className="p-8 relative">
                        ...
                        {scanState !== 'IDLE' && scanState !== 'ERROR' && (
                            ...
                            >
                                <div className="relative w-24 h-24 mb-6">
                                    <div className="absolute inset-0 border-t-2 border-b-2 border-matrix-green rounded-full animate-spin"></div>
                                    <div className="absolute inset-2 border-l-2 border-r-2 border-matrix-green/50 rounded-full animate-spin-slow reverse"></div>
                                    <Lock size={32} className="absolute inset-0 m-auto text-matrix-green animate-pulse" />
                                </div>
                                <div className="text-matrix-green font-mono text-xs tracking-[0.2em] animate-pulse">
                    ...
                    <div className="mt-8 text-center flex items-center justify-center gap-2">
                        <Shield size={12} className="text-matrix-green/50" />
                ...
                <div className="bg-black p-1 border-t border-gray-800 flex justify-between px-2">
                    <div className="flex gap-1">
                        <div className="w-1 h-1 bg-matrix-green animate-pulse"></div>
                        <div className="w-1 h-1 bg-matrix-green animate-pulse delay-75"></div>
                        <div className="w-1 h-1 bg-matrix-green animate-pulse delay-150"></div>
                    </div>
                </div>
            </motion.div>
        </div>
