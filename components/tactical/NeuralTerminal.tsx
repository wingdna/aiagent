...
export const NeuralTerminal: React.FC<NeuralTerminalProps> = ({
    ...
    return (
        ...
        <m.div
            ...
            className="absolute inset-0 z-40 bg-slate-950/90 flex flex-col overflow-hidden pointer-events-auto"
            style={{
        ...
        >
                            ...
                            >
                                ...
                                <div
                                    className={`text-sm leading-relaxed font-sans font-light selection:bg-cyan-900/50 ${isUser
                                            ? 'text-slate-200 border border-white/5 bg-white/[0.02] px-4 py-2.5 rounded-lg rounded-tr-sm'
                                            : 'text-cyan-50'
                                        }`}
                                >
            ...
            <div className="relative z-20 p-6 pt-2 bg-gradient-to-t from-slate-950 via-slate-950 to-transparent">
                <div className="relative flex items-end bg-black/40 border border-white/10 rounded-xl transition-all duration-300 focus-within:border-cyan-500/40 focus-within:bg-black/60">
                    <textarea
                        ref={textareaRef}
                        value={input}
