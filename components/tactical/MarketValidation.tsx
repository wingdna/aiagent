    ...
    return (
        <div className="bg-black/20 border border-white/5 rounded-xl p-4 backdrop-blur-sm mt-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-2 gap-3">
                ...
                {hasGithub && (
                    <div className="bg-white/5 border border-white/10 rounded-lg p-3 flex flex-col items-center justify-center hover:bg-white/10 transition-colors group cursor-pointer" onClick={() => socials.github && window.open(socials.github, '_blank')}>
