...
import { 
    ...
    HardDrive, MousePointerClick, TrendingUp, Shield, HelpCircle, Globe, Zap
} from 'lucide-react';
...
const BADGE_STYLES: Record<string, { icon: any, label: string, style: string, iconColor: string }> = {
    'CLOUD_ONLY': { 
        icon: Globe, 
        label: 'CLOUD', 
        style: 'border-blue-500/60 bg-blue-900/20 shadow-[0_0_12px_rgba(59,130,246,0.5)]', 
        iconColor: 'text-blue-400' 
    },
    'API_UPLINK': { 
        icon: Zap, 
        label: 'API', 
        style: 'border-yellow-500/60 bg-yellow-900/20 shadow-[0_0_12px_rgba(234,179,8,0.5)]', 
        iconColor: 'text-yellow-400' 
    },
    'AUTONOMOUS': { 
        icon: Sparkles, 
        label: 'AUTO', 
        style: 'border-purple-500/60 bg-purple-900/20 shadow-[0_0_12px_rgba(168,85,247,0.5)] animate-pulse', 
    ...
    'NEW_BORN': { 
        icon: Sparkles, 
        label: 'NEW', 
        style: 'border-cyan-500/50 bg-cyan-500/10 shadow-[0_0_8px_rgba(34,211,238,0.3)]', 
        iconColor: 'text-cyan-400' 
    },
    'LOCAL': { 
        icon: HardDrive, 
