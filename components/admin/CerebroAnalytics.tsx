    ...
    return (
        <div className="flex flex-col h-full bg-black/40 p-6 gap-6">
            ...
            <div className="flex items-center justify-between bg-gray-900/50 border border-gray-800 p-3 rounded-lg">
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs font-mono text-white font-bold tracking-widest flex items-center gap-2">
                        AUTO_PUBLISH: <span className="text-cyan-400">ACTIVE</span>
                    </span>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                {/* CARD 3: SNAPSHOT */}
                <div className="bg-gray-900/50 border border-gray-800 p-6 rounded-xl flex flex-col items-center text-center hover:border-cyan-400 transition-colors">
                    <div className="p-4 rounded-full bg-cyan-900/20 text-cyan-400 mb-4">
                        <Save size={32} />
                    </div>
                    ...
                    <button 
                        onClick={runSnapshot}
                        disabled={isProcessing}
                        className="w-full py-3 bg-cyan-400 hover:bg-cyan-300 text-black font-mono font-bold text-xs rounded transition-all disabled:opacity-50"
                    >
            ...
            <div className="flex-1 bg-black border border-gray-800 rounded-xl p-4 font-mono text-xs overflow-y-auto custom-scrollbar">
                ...
                {isProcessing && <div className="text-cyan-400 animate-pulse">_PROCESSING_REQUEST...</div>}
            </div>
        </div>
    );
};
