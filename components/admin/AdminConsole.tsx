                ...
                <div className="bg-red-950/20 border-b border-red-900/30 p-4 flex justify-between items-center shrink-0">
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex bg-black/40 rounded p-1 border border-red-900/20 gap-1">
                            ...
                            <button onClick={() => setView('CEREBRO')} className={`px-4 py-1 text-xs font-mono font-bold rounded ${view === 'CEREBRO' ? 'bg-matrix-green/20 text-matrix-green' : 'text-gray-500'}`}>CEREBRO_ENGINE</button>
                                ...
                                <div className="space-y-4 flex flex-col">
                                    <div className="bg-red-900/10 border border-red-500/50 p-4 rounded-lg">
                                        ...
                                        <p className="text-[10px] text-gray-400 font-mono mb-4 leading-relaxed">
                                            ...
                                            If you don't have it, we will try with the <span className="text-matrix-green">ANON_KEY</span> as requested.
                                        </p>
                                        <input 
                                            type="password"
                                    ...
                                    <div className="flex-1">
                                        {logs.map((log, i) => (
                                            <div key={i} className={`mb-1 ${
                                                log.includes("SUCCESS") ? "text-matrix-green" : 
